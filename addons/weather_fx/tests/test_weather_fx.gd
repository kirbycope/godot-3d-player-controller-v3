...
func test_grass_material_resource() -> void:
	...
	assert_not_null(mat.get_shader_parameter("color_gradient"))
	assert_not_null(mat.get_shader_parameter("shape_atlas"))
	assert_not_null(mat.get_shader_parameter("wind_velocity"))
