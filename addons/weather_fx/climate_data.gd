...
const WEATHER_ICON_PATHS: Dictionary = {
	WeatherType.BLUE_SKY: "res://addons/weather_fx/icons/bluesky.svg",
	WeatherType.CLOUDY: "res://addons/weather_fx/icons/cloudy.svg",
	WeatherType.RAIN: "res://addons/weather_fx/icons/rain.svg",
	WeatherType.HEAVY_RAIN: "res://addons/weather_fx/icons/heavy_rain.svg",
	WeatherType.STORM: "res://addons/weather_fx/icons/storm.svg",
	WeatherType.SNOW: "res://addons/weather_fx/icons/snow.svg",
	WeatherType.HEAVY_SNOW: "res://addons/weather_fx/icons/heavy_snow.svg",
}
...
static func get_weather_icon_path(type: WeatherType) -> String:
	return WEATHER_ICON_PATHS.get(type, "res://addons/weather_fx/icons/bluesky.svg")
